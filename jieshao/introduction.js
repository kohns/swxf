...
/*隐藏视屏播放*/
var overwatch_trailer=document.getElementsByClassName("overwatch-trailer")[0];
var closeBtn=document.getElementsByClassName("closeBtn")[0];
    overwatch_trailer.onclick=function(){
...
/*侧面导航栏*/
var lis=document.querySelectorAll("#daohang li");
for( let i=0;i<lis.length;i++){
    lis[i].onmouseover=function(){
       $("D-menu"+(i+1)).style.left="0px" ;
    }
    lis[i].onmouseout=function(){
        $("D-menu"+(i+1)).style.left="70px" ;
    }
}